...
```
git clone git@github.com:gsmainclusivetechlab/mmapi-javascript-sdk.git
cd mmapi-javascript-sdk
```

-   Install all dependencys defined in `package.json` to configure project setup:
