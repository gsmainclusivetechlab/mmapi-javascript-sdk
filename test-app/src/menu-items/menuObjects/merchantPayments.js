const merchantPay = [
    ...
    // },
    {
        ...
        title: 'Payee-Initiated Merchant Payment Generate Pre-authorised Payment Code',
        type: 'item',
    ...
    },
    {
        ...
        params: [],
        testSuccessParams: ['authorisationCode', 'codeState'],
        testErrorParams: ['errorCategory', 'errorCode'],
    },
    {
        id: 'payeeInitiatedMerchantPaymentPreAuthCode',
        title: 'Payee-Initiated Merchant Payment using a Pre-authorised Payment Code',
        type: 'item',
        requestType: 'createMerchantTransaction',
        requestCategory: 'MerchantPayment',
        target: true,
