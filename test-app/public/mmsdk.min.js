  ...
  var e = {
            ...
            if (e.auth) {
              var h = e.auth.username || "",
                b = e.auth.password
                  ...
                  : "";
              f.Authorization = "Basic " + btoa(h + ":" + b);
            }
        ...
        (l.prototype.request = function (e) {
          ...
          n.forEach(["delete", "get", "head", "options"], function (e) {
            l.prototype[e] = function (t, r) {
              return this.request(
                c(r || {}, { method: e, url: t, data: (r || {}).data })
              );
            };
          }),
        ...
        e.exports = function (e) {
          ...
          for (
            var i,
              ...
              u = Math.max(0, a.length - c.length),
              l = [],
              p = 0;
            p < u;
            p++
      ...
      584: (e, t, r) => {
        ...
        var u = function () {
          ...
          A = function (e) {
            ...
            var n = [];
            return (
              w(e, P, function (e, t, r, o) {
                n[n.length] = r ? w(o, x, "$1") : t || e;
              }),
              n
            );
          },
      ...
      291: (e, t, r) => {
        ...
        e.exports = function e(t, r, n, o) {
          ...
          var s = !R(c, "customInspect") || c.customInspect;
          ...
          function P(t, r, a) {
            if ((r && (o = o.slice()).push(r), a)) {
              var i = { depth: c.depth };
              return (
                R(c, "quoteStyle") && (i.quoteStyle = c.quoteStyle),
                e(t, i, n + 1, o)
              );
            }
            return e(t, c, n + 1, o);
          ...
          if (D(t)) {
            var W = j
              ...
              : O.call(t);
            return "object" != typeof t || j ? W : L(W);
          }
          if (
            (v = t) &&
            "object" == typeof v &&
            ...
            for (
              var X = "<" + String(t.nodeName).toLowerCase(),
                H = t.attributes || [],
                V = 0;
              V < H.length;
              V++
            )
              X += " " + H[V].name + "=" + k(E(H[V].value), "double", c);
            return (
              (X += ">"),
        ...
        function T(e, t) {
          ...
          return k(
            e.replace(/(['\\])/g, "\\$1").replace(/[\x00-\x1f]/g, F),
            "single",
            t
          );
        }
          ...
          for (var s in e)
            R(e, s) &&
              ((r && String(Number(s)) === s && s < e.length) ||
                (j && a["$" + s] instanceof Symbol) ||
                (/[^\w$]/.test(s)
                  ? n.push(t(s, e) + ": " + t(e[s], e))
                  : n.push(s + ": " + t(e[s], e))));
          if ("function" == typeof v)
            for (var u = 0; u < i.length; u++)
              w.call(e, i[u]) && n.push("[" + t(i[u]) + "]: " + t(e[i[u]], e));
          return n;
        }
      },
      280: (e) => {
        ...
        var n = r(706),
          ...
          u = function (e, t, r, n) {
            if (e) {
              ...
              for (
                var p = 0;
                r.depth > 0 && null !== (c = i.exec(a)) && p < r.depth;
      ...
      535: (e, t, r) => {
        ...
        var n = r(705),
          ...
          d = function e(t, r, a, i, c, u, p, f, d, h, b, m, g, v, O) {
            var j,
              w = t;
            ...
            if (
              ...
              if (i) return u && !g ? u(r, y.encoder, v, "key", b) : r;
              w = "";
            }
            if (
              "string" == typeof (j = w) ||
              ...
              return u
                ? [
                    m(g ? r : u(r, y.encoder, v, "key", b)) +
                      "=" +
                      m(u(w, y.encoder, v, "value", b)),
                  ]
                : [m(r) + "=" + m(String(w))];
            var S,
              P = [];
            ...
            if ("comma" === a && s(w))
              S = [{ value: w.length > 0 ? w.join(",") || null : void 0 }];
            else if (s(p)) S = p;
            else {
              var x = Object.keys(w);
              S = f ? x.sort(f) : x;
            ...
            for (var A = 0; A < S.length; ++A) {
              var k = S[A],
                E = "object" == typeof k && void 0 !== k.value ? k.value : w[k];
              if (!c || null !== E) {
                var I = s(w)
                  ? "function" == typeof a
                    ? a(r, k)
                ...
                O.set(t, !0);
                var D = n();
                l(P, e(E, I, a, i, c, u, p, f, d, h, b, m, g, v, D));
              }
            }
            return P;
          };
        ...
        e.exports = {
          ...
          compact: function (e) {
            for (
              ...
              for (
                var o = t[n], i = o.obj[o.prop], c = Object.keys(i), s = 0;
                s < c.length;
                ++s
              ) {
                var u = c[s],
            ...
            return (
              ...
              a(t) && a(r)
                ...
                : Object.keys(r).reduce(function (t, a) {
                    var i = r[a];
                    return (
                      o.call(t, a) ? (t[a] = e(t[a], i, n)) : (t[a] = i), t
                    );
                  }, i)
            );
          },
  ...
  (r.n = (e) => {
    ...
    (() => {
        ...
        e &&
          (n ? a : o)(e)
            ...
            .catch(function (e) {
              ...
              return r && e.response
                ? r(
                    null == e || null === (t = e.response) || void 0 === t
                      ? void 0
                      : t.data,
      ...
      for (var f = [], y = 0; y < 256; ++y)
        f.push((y + 256).toString(16).substr(1));
      ...
      function g(e, t, r, n) {
        ...
        if (e[t]) {
          var i = d(),
            c = b({ correlationId: i }, r);
          return (
            o && o(i),
            r.hasOwnProperty("notificationMethod") &&
            "polling" === r.notificationMethod
              ? r.hasOwnProperty("callbackUrl") && delete c.callbackUrl
              : r.hasOwnProperty("callbackUrl") || (a && (c.callbackUrl = a)),
            e[t](c, n)
          );
        }
        n(
          {
            ...
            errorParameters: [{ key: "type", value: t }],
          },
          "400"
        );
      }
        ...
        if (a && i)
          n(
            O(
              O({}, t.headers),
              {},
              { "X-API-Key": a, Authorization: "Bearer ".concat(i) }
            )
          );
        else if (c && s) {
          var u = window.btoa("".concat(c, ":").concat(s));
          r(O(O({}, t.headers), {}, { Authorization: "Bearer ".concat(u) }));
        } else r(O({}, t.headers));
      }
      var P = ["onSuccess", "onFailure", "type", "getClientCorrelationId"],
        x = ["tailingFunctionCall"];
      function A(e, t) {
        var r = Object.keys(e);
        if (Object.getOwnPropertySymbols) {
          var n = Object.getOwnPropertySymbols(e);
      ...
      function D(e) {
        var t =
          ...
          r = t.callbackUrl;
        return function (n) {
          if (n.hasOwnProperty("onFailure") && n.hasOwnProperty("onSuccess")) {
            var o = n.onSuccess,
              a = void 0 === o ? function () {} : o,
              c = n.onFailure,
              s = void 0 === c ? function () {} : c,
              u = n.type,
              l = n.getClientCorrelationId,
          ...
          } else console.error("Missing onSucess/onFailure in request !");
        };
      }
      var C = "viewAccountBalance",
        R = "viewServiceAvailability",
        U = "viewResponse",
        N = "viewRequestState",
        T = "viewTransaction",
        F = "createReversal",
        L = "viewAccountTransaction",
        B = "createQuotation",
        M = "viewQuotation",
        _ = "createMerchantTransaction",
        q = "createAuthorisationCode",
        W = "viewAuthorisationCode",
        X = "createDisbursementTransaction",
        H = "createBatchTransaction",
        V = "viewBatchTransaction",
        z = "viewBatchCompletions",
        J = "viewBatchRejections",
        G = "updateBatchTransaction",
        $ = "createInternationalTransaction",
        K = "viewAccountName",
        Q = "createTransferTransaction",
        Z = "createAccountDebitMandate",
        Y = "viewAccountDebitMandate",
        ee = "createAccountLink",
        te = "viewAccountLink",
        re = "createTransferTransaction";
      function ne(e, t) {
        var r = Object.keys(e);
        if (Object.getOwnPropertySymbols) {
          var n = Object.getOwnPropertySymbols(e);
      ...
      function ie() {
        var e =
          ...
          n = function () {
            ...
            t && (o = oe(oe({}, o), t));
            var a = { url: e, headers: o, method: "get" };
            return n && (a.params = n), r && (a.tailingFunctionCall = r), a;
          },
          o = function (r) {
            var n =
              arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
              ...
              headers: oe(
                ...
                {},
                {
                  "Content-Type": n
                    ? "multipart/form-data"
                    : "application/json",
                  Accept: n ? "multipart/form-data" : "application/json",
                }
              ),
              data: r,
              method: "post",
          ...
          if (t.length > 0) {
            ...
            return (
              t.forEach(function (t) {
                e.hasOwnProperty(t) || n.push({ key: t, value: "" });
              }),
              !(
                r &&
                n.length > 0 &&
      ...
      var pe,
        fe =
          (le((ue = {}), C, function (e, t) {
            if (ce(e, ["accountId"], t)) {
              var r = e.accountId;
              return se(r, t, function (e) {
                return ie("/accounts/".concat(e, "/balance")).get();
              });
            }
          }),
          le(ue, R, function () {
            return ie("/heartbeat").get();
          }),
          le(ue, U, function (e, t) {
            if (ce(e, ["clientCorrelationId"], t)) {
              var r = e.clientCorrelationId;
              return ie("/responses/".concat(r), null, function (e, t) {
                if (ce(e, ["link"], t)) return ie(e.link).get();
              }).get();
            }
          }),
          le(ue, N, function (e, t) {
            if (ce(e, ["serverCorrelationId"], t)) {
              var r = e.serverCorrelationId;
              return ie("/requeststates/".concat(r)).get();
            }
          }),
          le(ue, T, function (e, t) {
            if (ce(e, ["transactionReference"], t)) {
              var r = e.transactionReference;
              return ie("/transactions/".concat(r)).get();
            }
          }),
          le(ue, F, function (e, t) {
            if (ce(e, ["transactionReference"], t)) {
              var r = e.data,
                n = void 0 === r ? { type: "reversal" } : r,
                o = e.correlationId,
                a = void 0 === o ? "" : o,
                i = e.callbackUrl,
                c = e.transactionReference,
                s = { "X-CorrelationID": a };
              return (
                i && (s["X-Callback-URL"] = i),
                ie("/transactions/".concat(c, "/reversals"), s).post(n)
              );
            }
          }),
          le(ue, L, function (e, t) {
            if (ce(e, ["accountId"], t)) {
              var r = e.accountId,
                n = e.offset,
                o = void 0 === n ? null : n,
              ...
              return (
                ...
                i && (c.limit = i),
                se(r, t, function (e) {
                  return ie("/accounts/".concat(e, "/transactions")).get(c);
                })
              );
            }
            return ie(
              "/accounts/"
                .concat(identifierType, "/")
                .concat(identifier, "/transactions")
            ).get(params);
          }),
          le(ue, B, function (e, t) {
            var r = e.correlationId,
              n = e.callbackUrl,
              o = e.data;
            if (ce(e, ["data"], t)) {
              var a = { "X-CorrelationID": r };
              return (
                n && (a["X-Callback-URL"] = n), ie("/quotations", a).post(o)
              );
            }
          }),
          le(ue, M, function (e, t) {
            if (ce(e, ["quotationReference"], t)) {
              var r = e.quotationReference;
              return ie("/quotations/".concat(r)).get();
            }
          }),
          le(ue, e.REFUND, function (e, t) {
            if (ce(e, ["data"], t)) {
              var r = e.data,
                n = e.correlationId,
                o = void 0 === n ? "" : n,
                ...
                i = { "X-CorrelationID": o };
              return (
                a && (i["X-Callback-URL"] = a),
                ie("/transactions/type/adjustment", i).post(r)
              );
            }
          }),
          ue);
      function ye(e, t) {
        if (ce(e, ["data"], t)) {
          var r = e.correlationId,
            ...
            a = { "X-CorrelationID": r };
          return (
            n && (a["X-Callback-URL"] = n),
            ie("/transactions/type/merchantpay", a).post(o)
          );
        }
      }
      function de(e, t) {
      ...
      const be = (function (e) {
        ...
        (he((pe = {}), _, ye),
        he(pe, q, function (e, t) {
          if (ce(e, ["data", "accountId"], t)) {
            var r = e.accountId,
              n = e.data,
              o = e.correlationId,
              a = e.callbackUrl,
            ...
            return (
              ...
              se(r, t, function (e) {
                return ie(
                  "/accounts/".concat(e, "/authorisationcodes"),
                  i
                ).post(n);
              })
            );
        ...
        he(pe, W, function (e, t) {
          if (ce(e, ["accountId", "authorisationCode"], t)) {
            var r = e.accountId,
              n = e.authorisationCode;
            return se(r, t, function (e) {
              return ie(
                "/accounts/".concat(e, "/authorisationcodes/").concat(n)
              ).get();
            });
          }
        }),
      ...
      const Oe = (function (e) {
        ...
        (ve((me = {}), X, function (e, t) {
          ...
          if (ce(e, ["data"], t)) {
            ...
            return (
              n && (a["X-Callback-URL"] = n),
              ie("/transactions/type/disbursement", a).post(o)
            );
          }
        }),
        ve(me, H, function (e, t) {
          var r = e.correlationId,
            n = e.callbackUrl,
            o = e.data;
          if (ce(e, ["data"], t)) {
            ...
            return (
              n && (a["X-Callback-URL"] = n),
              ie("/batchtransactions", a).post(o)
            );
          }
        }),
        ve(me, V, function (e, t) {
          if (ce(e, ["batchId"], t)) {
            var r = e.batchId;
            return ie("/batchtransactions/".concat(r)).get();
          }
        }),
        ve(me, z, function (e, t) {
          if (ce(e, ["batchId"], t)) {
            var r = e.batchId;
            return ie("/batchtransactions/".concat(r, "/completions")).get();
          }
        }),
        ve(me, J, function (e, t) {
          if (ce(e, ["batchId"], t)) {
            var r = e.batchId;
            return ie("/batchtransactions/".concat(r, "/rejections")).get();
          }
        }),
        ve(me, G, function (e, t) {
          var r = e.correlationId,
            n = e.callbackUrl,
            o = e.data,
            a =
              void 0 === o
                ? [{ op: "replace", path: "/batchStatus", value: "approved" }]
                : o;
          if (ce(e, ["batchId"], t)) {
            var i = { "X-CorrelationID": r };
            n && (i["X-Callback-URL"] = n);
            var c = e.batchId;
            return ie("/batchtransactions/".concat(c), i).patch(a);
          }
        }),
        me),
        fe
      ...
      const Se = (function (e) {
        ...
        we({}, $, function (e, t) {
          ...
          if (ce(e, ["data"], t)) {
            ...
            return (
              n && (a["X-Callback-URL"] = n),
              ie("/transactions/type/inttransfer", a).post(o)
            );
          }
        }),
        fe
      ...
      const ke = (function (e) {
        ...
        (Ae((Pe = {}), K, function (e, t) {
          if (ce(e, ["accountId"], t)) {
            var r = e.accountId;
            return se(r, t, function (e) {
              return ie("/accounts/".concat(e, "/accountname")).get();
            });
          }
        }),
        Ae(Pe, Q, function (e, t) {
          var r = e.correlationId,
            n = e.callbackUrl,
            o = e.data;
          if (ce(e, ["data"], t)) {
            ...
            return (
              n && (a["X-Callback-URL"] = n),
              ie("/transactions/type/transfer", a).post(o)
            );
          }
        }),
        Pe),
        ...
        (De((Ee = {}), Z, function (e, t) {
          if (ce(e, ["data", "accountId"], t)) {
            ...
            return (
              n && (i["X-Callback-URL"] = n),
              se(a, t, function (e) {
                return ie("/accounts/".concat(e, "/debitmandates"), i).post(o);
              })
            );
          }
          return se(accountId, t, function (e) {
            return ie("/accounts/".concat(e, "/debitmandates"), header).post(
              data
            );
          });
        }),
        De(Ee, _, ye),
        De(Ee, Y, function (e, t) {
          if (ce(e, ["accountId", "mandateReference"], t)) {
            var r = e.accountId,
              n = e.mandateReference;
            return se(r, t, function (e) {
              return ie(
                "/accounts/".concat(e, "/debitmandates/").concat(n)
              ).get();
            });
          }
        }),
        ...
        (Ne((Re = {}), ee, function (e, t) {
          if (ce(e, ["data", "accountId"], t)) {
            ...
            return (
              n && (i["X-Callback-URL"] = n),
              se(a, t, function (e) {
                return ie("/accounts/".concat(e, "/links"), i).post(o);
              })
            );
          }
        }),
        Ne(Re, te, function (e, t) {
          if (ce(e, ["accountId", "linkReference"], t)) {
            var r = e.accountId,
              n = e.linkReference;
            return se(r, t, function (e) {
              return ie("/accounts/".concat(e, "/links/").concat(n)).get();
            });
          }
        }),
        Ne(Re, re, function (e, t) {
          var r = e.correlationId,
            n = e.callbackUrl,
            o = e.data;
          if (ce(e, ["data"], t)) {
      ...
      var Fe = function (e) {
          window.gsma.auth = {
            MerchantPayment: D(be, e),
            Disbursement: D(Oe, e),
            InternationalTransfer: D(Se, e),
            P2PTransfer: D(ke, e),
            RecurringPayment: D(Ce, e),
            AccountLinking: D(Te, e),
          };
        },
        Le = {
          MerchantPayment: D(be),
          Disbursement: D(Oe),
          InternationalTransfer: D(Se),
          P2PTransfer: D(ke),
          RecurringPayment: D(Ce),
          AccountLinking: D(Te, authHeaders),
        },
        Be = r(520),
        Me = r.n(Be);
      function _e(e) {
        ...
        !(function (e) {
          var t = e.username,
            ...
            o = e.onSuccess,
            a = e.onFailure,
            i = window.btoa("".concat(t, ":").concat(r));
          n()
            .post(
              "https://sandbox.mobilemoneyapi.io/v1/oauth/accesstoken",
              Me().stringify({ grant_type: "client_credentials" }),
              {
                headers: {
            ...
            .then(function (e) {
              o(null == e ? void 0 : e.data, null == e ? void 0 : e.status);
            })
            .catch(function (e) {
              var t, r;
              e && e.response
                ? a(
                    (null != e &&
                      ...
                      void 0 !== t &&
                      t.data,
                    null == e || null === (r = e.response) || void 0 === r
                      ? void 0
                      : r.status)
                  )
                : a(e);
          ...
          onSuccess: function (e) {
            ...
            Fe({ apiKey: o, accessToken: t, callbackUrl }),
              a("You can access our functions using : window.gsma.auth");
          },
      ...
      var qe = function (e) {
        var t = e.access_token,
          ...
          n = {
            access_token: t,
            expires_in: r,
            expires_at: new Date().getTime() / 1e3 + r,
            created_at: new Date().getTime() / 1e3,
          };
        sessionStorage.setItem("mmSdkToken", JSON.stringify(n));
      };
      window.gsma = {
        initBasicAuth: function (e, t) {
          var r =
            arguments.length > 2 && void 0 !== arguments[2]
              ? arguments[2]
              : null;
          Fe({ username: e, pass: t, callbackUrl: r });
        },
        initStandardAuth: function (e) {
          var t,
            r = e.username,
            n = e.pass,
            o = e.apiKey,
          ...
          if (sessionStorage.getItem("mmSdkToken")) {
            var u = JSON.parse(sessionStorage.getItem("mmSdkToken")),
              l = u.access_token,
              p = u.expires_at;
            l && ((t = p), new Date().getTime() / 1e3 < t) && l.length > 0
              ? (Fe({ apiKey: o, accessToken: l, callbackUrl: i }),
                c("You can access our functions using : window.gsma.auth"))
              : _e({
                  username: r,
                  pass: n,
                  apiKey: o,
            ...
            _e({ username: r, pass: n, apiKey: o, onSuccess: c, onFailure: s });
        },
        noAuth: Le,
      };
    })();
