  ...
  var e = {
      ...
      291: (e, t, r) => {
        ...
        e.exports = function e(t, r, n, o) {
          ...
          var s = !D(c, "customInspect") || c.customInspect;
          ...
          function P(t, r, a) {
            if ((r && (o = o.slice()).push(r), a)) {
              var i = { depth: c.depth };
              return (
                D(c, "quoteStyle") && (i.quoteStyle = c.quoteStyle),
                e(t, i, n + 1, o)
              );
            }
            return e(t, c, n + 1, o);
          ...
          if (C(t)) {
            var W = j
              ...
              : O.call(t);
            return "object" != typeof t || j ? W : B(W);
          }
          if (
            (v = t) &&
            "object" == typeof v &&
            ...
            for (
              ...
              V += " " + H[X].name + "=" + k(E(H[X].value), "double", c);
            return (
              (V += ">"),
        ...
        function q(e, t) {
          ...
          if (r) {
            n.length = e.length;
            for (var o = 0; o < e.length; o++) n[o] = D(e, o) ? t(e[o], e) : "";
          }
          var a,
          ...
          d = function e(t, r, a, i, c, u, p, f, d, h, b, m, g, v, O) {
            ...
            for (var A = 0; A < S.length; ++A) {
              ...
              if (!c || null !== E) {
                ...
                O.set(t, !0);
                var C = n();
                l(P, e(E, I, a, i, c, u, p, f, d, h, b, m, g, v, C));
              }
            }
            return P;
          };
    ...
    (() => {
      ...
      function w(e, t, r, n, o) {
        ...
        if (a && i)
          ...
          r(v(v({}, t.headers), {}, { Authorization: "Bearer ".concat(u) }));
        } else r(v({}, t.headers));
      }
      var S = ["onSuccess", "onFailure", "type", "getClientCorrelationId"],
        P = ["tailingFunctionCall"];
      function x(e, t) {
        var r = Object.keys(e);
        if (Object.getOwnPropertySymbols) {
          var n = Object.getOwnPropertySymbols(e);
      ...
      var C = "createMerchantTransaction";
      function R(e, t) {
        var r = Object.keys(e);
        if (Object.getOwnPropertySymbols) {
          var n = Object.getOwnPropertySymbols(e);
      ...
      var L,
        _ =
          (M((B = {}), "viewAccountBalance", function (e, t) {
            if (T(e, ["accountId"], t)) {
              var r = e.accountId;
              return F(r, t, function (e) {
                return N("/accounts/".concat(e, "/balance")).get();
              });
            }
          }),
          M(B, "viewServiceAvailability", function () {
            return N("/heartbeat").get();
          }),
          M(B, "viewResponse", function (e, t) {
            if (T(e, ["clientCorrelationId"], t)) {
              var r = e.clientCorrelationId;
              return N("/responses/".concat(r), null, function (e, t) {
                if (T(e, ["link"], t)) return N(e.link).get();
              }).get();
            }
          }),
          M(B, "viewRequestState", function (e, t) {
            if (T(e, ["serverCorrelationId"], t)) {
              var r = e.serverCorrelationId;
              return N("/requeststates/".concat(r)).get();
            }
          }),
          M(B, "viewTransaction", function (e, t) {
            if (T(e, ["transactionReference"], t)) {
              var r = e.transactionReference;
              return N("/transactions/".concat(r)).get();
            }
          }),
          M(B, "createReversal", function (e, t) {
            if (T(e, ["transactionReference"], t)) {
              var r = e.data,
              ...
              return (
                ...
                N("/transactions/".concat(c, "/reversals"), s).post(n)
              );
            }
          }),
          M(B, "viewAccountTransaction", function (e, t) {
            if (T(e, ["accountId"], t)) {
              var r = e.accountId,
                n = e.offset,
                o = void 0 === n ? null : n,
              ...
              return (
                ...
                i && (c.limit = i),
                F(r, t, function (e) {
                  return N("/accounts/".concat(e, "/transactions")).get(c);
                })
              );
            }
            return N(
          ...
          M(B, "createQuotation", function (e, t) {
            ...
            if (T(e, ["data"], t)) {
              ...
              return (
                n && (a["X-Callback-URL"] = n), N("/quotations", a).post(o)
              );
            }
          }),
          M(B, "viewQuotation", function (e, t) {
            if (T(e, ["quotationReference"], t)) {
              var r = e.quotationReference;
              return N("/quotations/".concat(r)).get();
            }
          }),
          M(B, "createRefundTransaction", function (e, t) {
            if (T(e, ["data"], t)) {
              var r = e.data,
                n = e.correlationId,
                o = void 0 === n ? "" : n,
              ...
              return (
                ...
                N("/transactions/type/adjustment", i).post(r)
              );
            }
          }),
          B);
      function q(e, t) {
        if (T(e, ["data"], t)) {
          ...
          return (
            ...
            N("/transactions/type/merchantpay", a).post(o)
          );
        }
      }
      function W(e, t) {
      ...
      const H = (function (e) {
        ...
        (V((L = {}), C, q),
        V(L, "createAuthorisationCode", function (e, t) {
          if (T(e, ["data", "accountId"], t)) {
            var r = e.accountId,
              n = e.data,
              o = e.correlationId,
              a = e.callbackUrl,
            ...
            return (
              a && (i["X-Callback-URL"] = a),
              F(r, t, function (e) {
                return N("/accounts/".concat(e, "/authorisationcodes"), i).post(
                  n
                );
              })
            );
        ...
        V(L, "viewAuthorisationCode", function (e, t) {
          if (T(e, ["accountId", "authorisationCode"], t)) {
            var r = e.accountId,
      ...
      const G = (function (e) {
        ...
        (J((X = {}), "createDisbursementTransaction", function (e, t) {
          var r = e.correlationId,
            n = e.callbackUrl,
            o = e.data;
          if (T(e, ["data"], t)) {
            ...
            return (
              n && (a["X-Callback-URL"] = n),
              N("/transactions/type/disbursement", a).post(o)
            );
          }
        }),
        J(X, "createBatchTransaction", function (e, t) {
          var r = e.correlationId,
            n = e.callbackUrl,
            o = e.data;
          if (T(e, ["data"], t)) {
            var a = { "X-CorrelationID": r };
            return (
              n && (a["X-Callback-URL"] = n), N("/batchtransactions", a).post(o)
            );
          }
        }),
        J(X, "viewBatchTransaction", function (e, t) {
          if (T(e, ["batchId"], t)) {
            var r = e.batchId;
            return N("/batchtransactions/".concat(r)).get();
          }
        }),
        J(X, "viewBatchCompletions", function (e, t) {
          if (T(e, ["batchId"], t)) {
            var r = e.batchId;
            return N("/batchtransactions/".concat(r, "/completions")).get();
          }
        }),
        J(X, "viewBatchRejections", function (e, t) {
          if (T(e, ["batchId"], t)) {
            var r = e.batchId;
            return N("/batchtransactions/".concat(r, "/rejections")).get();
          }
        }),
        J(X, "updateBatchTransaction", function (e, t) {
          var r = e.correlationId,
            n = e.callbackUrl,
            o = e.data,
            a =
          ...
          if (T(e, ["batchId"], t)) {
            ...
            var c = e.batchId;
            return N("/batchtransactions/".concat(c), i).patch(a);
          }
        }),
        X),
        _
      ...
      const Q = (function (e) {
        ...
        K({}, "createInternationalTransaction", function (e, t) {
          var r = e.correlationId,
            n = e.callbackUrl,
            o = e.data;
          if (T(e, ["data"], t)) {
            ...
            return (
              n && (a["X-Callback-URL"] = n),
              N("/transactions/type/inttransfer", a).post(o)
            );
          }
        }),
        _
      ...
      const te = (function (e) {
        ...
        (ee((Y = {}), "viewAccountName", function (e, t) {
          if (T(e, ["accountId"], t)) {
            var r = e.accountId;
            return F(r, t, function (e) {
              return N("/accounts/".concat(e, "/accountname")).get();
            });
          }
        }),
        ee(Y, "createTransferTransaction", function (e, t) {
          var r = e.correlationId,
            n = e.callbackUrl,
            o = e.data;
          if (T(e, ["data"], t)) {
            ...
            return (
              n && (a["X-Callback-URL"] = n),
              N("/transactions/type/transfer", a).post(o)
            );
          }
        }),
        Y),
      ...
      const ae = (function (e) {
        ...
        (oe((re = {}), "createAccountDebitMandate", function (e, t) {
          var r = e.correlationId,
            n = e.callbackUrl,
            o = e.accountId,
            a = e.data;
          if (T(e, ["data", "accountId"], t)) {
            ...
            return (
              n && (i["X-Callback-URL"] = n),
              F(o, t, function (e) {
                return N("/accounts/".concat(e, "/debitmandates"), i).post(a);
              })
            );
          }
        }),
        oe(re, C, q),
        oe(re, "viewAccountDebitMandate", function (e, t) {
          if (T(e, ["accountId", "mandateReference"], t)) {
            var r = e.accountId,
      ...
      var ie = function (e) {
          window.gsma.auth = {
            MerchantPayment: I(H, e),
            Disbursement: I(G, e),
            InternationalTransfer: I(Q, e),
            P2PTransfer: I(te, e),
            RecurringPayment: I(ae, e),
          };
        },
        ce = {
          MerchantPayment: I(H),
          Disbursement: I(G),
          InternationalTransfer: I(Q),
          P2PTransfer: I(te),
          RecurringPayment: I(ae),
        },
        se = r(520),
        ue = r.n(se);
      function le(e) {
        ...
        !(function (e) {
          var r = e.username,
            ...
            o = e.onSuccess,
            a = e.onFailure,
            i = window.btoa("".concat(r, ":").concat(n));
          t()
            .post(
              "https://sandbox.mobilemoneyapi.io/v1/oauth/accesstoken",
              ue().stringify({ grant_type: "client_credentials" }),
              {
                headers: {
          ...
          onSuccess: function (e) {
            ...
            ie({ apiKey: o, accessToken: t, callbackUrl }),
        ...
        initBasicAuth: function (e, t) {
          var r =
            arguments.length > 2 && void 0 !== arguments[2]
              ? arguments[2]
              : null;
          ie({ username: e, pass: t, callbackUrl: r });
        },
        initStandardAuth: function (e) {
          ...
          if (sessionStorage.getItem("mmSdkToken")) {
            ...
            l && ((t = p), new Date().getTime() / 1e3 < t) && l.length > 0
              ? (ie({ apiKey: o, accessToken: l, callbackUrl: i }),
            ...
            le({ username: r, pass: n, apiKey: o, onSuccess: c, onFailure: s });
        },
        noAuth: ce,
      };
    })();
